...
import { createRegionActiveSignalsRoutes, createRegionRiskRoutes, regionsRoutes } from "./regions";
...
export function createApp(options: AppOptions = {}) {
  ...
  if (options.signals) {
    ...
    app.route("/regions", createRegionRiskRoutes({ store: options.signals }));
  }
