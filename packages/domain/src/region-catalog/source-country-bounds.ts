// Source basis: Natural Earth admin-0 110m country polygons,
// bounding boxes derived via:
//   https://raw.githubusercontent.com/danielb2/country-bounding-boxes/master/bounding-boxes.json
// Format: [alpha2, west, south, east, north] in WGS84 decimal degrees.
// Countries without recorded bounds (small island nations and territories)
// are intentionally omitted; the matcher treats missing entries as
// "no point matching" and falls back to region/global-only inclusion.
export type CountryBoundsRecord = readonly [
  alpha2: string,
  west: number,
  south: number,
  east: number,
...
export const countryBoundsRecords: readonly CountryBoundsRecord[] = [
